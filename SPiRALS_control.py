...
refant      = 2                     # {1: 'CD', 2: 'HO', 3: 'KE', 4: 'YG'} if AUS, {1:'AT',2:'CD',3:'HO',4:'MP',5:'PA',6:'WA'} if LBA
...
channel     = 513                 # channel used for fringe fit after cvel

pos_shift   = {'G232.62-0.99' : [ 0.018220, 0.244383],
