...
refant      = 1                 # {1: 'CD', 2: 'HB', 3: 'KE', 4: 'WA'}
calsource   = ['G232.62-0.99'][0] # calibrator '' => automatically
target      = ['J0725','J0729','J0735','J0748','F0730-1141'] # continuum sources '' => automatically
mp_source   = ['F0730-1141']    # fringe finder     '' => automatically
mp_timera   = [0, 8, 54, 12, 0, 8, 55, 7]  # constrain time range for fringe finder?
...
velchan     =  251              #  channel used for cvel, default 0=>Nchan/2+1
vel         = [23.08]           #  Velocity for cvel in band center
#
channel     = 251               # channel used for fringe fit after cvel
#
pos_shift   = {'G232.62-0.99' : [ 0.018420, 0.243583],
...
print_sn_flag   = 0      # Print out qqqlast SN table?
