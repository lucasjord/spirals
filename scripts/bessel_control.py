...
def_file    = '/Users/lucas3/spirals/scripts/definitions_bessel_3.py'
aipsver     = '31DEC25'
...
file_path   = '/Users/lucas3/bessel/{}/files/'.format(args.epoch.lower())
eop_path    = '/Users/lucas3/bessel/{}/eop/'.format(args.epoch.lower())
fit_path    = '/Users/lucas3/bessel/fit/'
mv_path     = '/Users/lucas3/analysis/multiview_4x/'
...
refant      = 9                 
calsource   = [''][0]     # calibrator        '' => automatically
...
velchan     =  1000                #  channel used for cvel, default 0=>Nchan/2+1
...
if __name__=='__main__':
    exec(compile(open(r''+def_file, "rb").read(), r''+def_file, 'exec'))
